...
export async function createUser(user: INewUser) {
    ...
    try {
        const res = await axios.post<{ message: string, token: any }>(BASE_URL+"create-user/", user)
...
export async function signInUser(user:{
    ...
    try {
        ...
        const res = await axios.post<{ message: string,status:number ,token: any }>(BASE_URL+"login-user/",user)
        // console.log(res)
...
export async function getCurrentUser() {
    ...
    try {
        ...
        const res= await axios.get<{user:any}>(BASE_URL+"get-current-user/",{params:data})
...
export async function getUserByUsername(username:string) {
    ...
    try {
        ...
        const res= await axios.get<{user:any}>(BASE_URL+"get-user-by-username/",{params:data})
...
export async function getUserBySearch(value:string) {
    ...
    try {
        ...
        const res= await axios.get<{users:any}>(BASE_URL+"get-user-by-search/",{params:data})
...
export async function getPostByUsername(username:string) {
    ...
    try {
        let data={username:username}
        const res= await axios.get<{posts:any}>(BASE_URL+"get-posts-by-username/",{params:data})
        console.log(res.data)
        return res.data.posts
...
export async function deletePost(postId:any) {
    try {
        ...
        const res= await axios.delete<{post:any}>(BASE_URL+`delete-post/${postId.id}/`)
        return res.data
...
export async function deleteSavedPost(post:any) {
    try {
        const res= await axios.delete(BASE_URL+"delete-saved-post/",{params:post})
        console.log(res.data)
...
export async function checkSavedPost(postData:any) {
    try {
        ...
        const res= await axios.get(BASE_URL+`check-saved-post/`,{params:data})
...
export async function getSavedPosts() {
    try {
        ...
        const res= await axios.get<{posts:any}>(BASE_URL+`get-saved-posts/`,{params:data})
        console.log(res.data)
...
export async function getLikes(postId:any) {
    try {
        ...
        const res= await axios.get<{likesArr:any}>(BASE_URL+`get-likes/${postId}/`)
