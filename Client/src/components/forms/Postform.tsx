...
const Postform = ({ post,currentUser }:PostFormProps) => {
    ...
    async function onSubmit(values: z.infer<typeof postValidation>,postData:any) {
        ...
        <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)}
                ...
                <div className="flex gap-4 items-center justify-end">
                    <Button className="shad-button_dark_4" onClick={()=>navigate("/")} type="button">Cancel</Button>
